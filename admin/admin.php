...
if(!defined('security')){
	...
	$mail=$_SESSION['mail'];
	$name="SELECT * FROM user WHERE user_mail='$mail'";
...
<body>
					...
					<div class="navbar-header">
						...
						<ul class="user-menu">
							<li class="dropdown pull-right">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> <?php echo $assoc['user_full']?> <span class="caret"></span></a>
	...
	if(isset($_GET['page_layout'])){
		switch($_GET['page_layout']){
			...
			case 'delete_product'; include_once('delete_product.php'); break;
			//category
