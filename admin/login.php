...
die('Bạn không thể truy cập trang này');
	...
	if(isset($_POST['sbm'])){
        ...
        if($responseKeys["success"]) {
			$sql="SELECT * FROM user WHERE user_mail='$email' AND user_pass='$pass' AND user_level ='1'";
				...
				<div class="panel-body">
					...
					<form role="form" method="post">
						<fieldset>
							...
							<div class="g-recaptcha" data-sitekey="6Ldqh8QUAAAAANeeRhE-NPae4WhkJw4BmRFgTWI2"></div>
